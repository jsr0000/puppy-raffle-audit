...
contract PuppyRaffle is ERC721, Ownable {
    ...
    function enterRaffle(address[] memory newPlayers) public payable {
        ...
        ); //@audit - could add a custom error
    ...
    function getActivePlayerIndex(
        ...
        // q what if index is 0?
        // @audit - if the player is at index 0, it will return 0 and the player might think they are not in the raffle
        return 0;
    }
